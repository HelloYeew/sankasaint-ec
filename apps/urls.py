...
urlpatterns = [
    ...
    path('election/legacy/<int:election_id>/edit', views.edit_election, name='edit_election'),
    path('election/legacy/<int:election_id>/vote', views.vote, name='vote'),
    path('election/legacy/<int:election_id>/history', views.vote_history, name='vote_history'),
    path('election/legacy/<int:election_id>/result', views.election_result, name='election_result'),
    path('election/legacy/<int:election_id>/detailed_result', views.detailed_election_result, name='detailed_election_result'),
